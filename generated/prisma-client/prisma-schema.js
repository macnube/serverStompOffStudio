...
type AggregateMailgunEmailPayload {
  count: Int!
}
...
type MailgunEmailPayloadConnection {
  pageInfo: PageInfo!
  edges: [MailgunEmailPayloadEdge]!
  aggregate: AggregateMailgunEmailPayload!
}

input MailgunEmailPayloadCreateInput {
  id: ID
  success: Boolean!
}

type MailgunEmailPayloadEdge {
  node: MailgunEmailPayload!
  cursor: String!
}

enum MailgunEmailPayloadOrderByInput {
  id_ASC
  id_DESC
  success_ASC
  success_DESC
...
type MailgunEmailPayloadPreviousValues {
  id: ID!
  success: Boolean!
}

type MailgunEmailPayloadSubscriptionPayload {
  mutation: MutationType!
  node: MailgunEmailPayload
  updatedFields: [String!]
...
input MailgunEmailPayloadSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: MailgunEmailPayloadWhereInput
  AND: [MailgunEmailPayloadSubscriptionWhereInput!]
  OR: [MailgunEmailPayloadSubscriptionWhereInput!]
  NOT: [MailgunEmailPayloadSubscriptionWhereInput!]
}

input MailgunEmailPayloadUpdateInput {
  success: Boolean
}

input MailgunEmailPayloadUpdateManyMutationInput {
  success: Boolean
}

input MailgunEmailPayloadWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  success: Boolean
  success_not: Boolean
  AND: [MailgunEmailPayloadWhereInput!]
  OR: [MailgunEmailPayloadWhereInput!]
  NOT: [MailgunEmailPayloadWhereInput!]
}

input MailgunEmailPayloadWhereUniqueInput {
  id: ID
}
...
type Mutation {
  ...
  createMailgunEmailPayload(data: MailgunEmailPayloadCreateInput!): MailgunEmailPayload!
  updateMailgunEmailPayload(data: MailgunEmailPayloadUpdateInput!, where: MailgunEmailPayloadWhereUniqueInput!): MailgunEmailPayload
  updateManyMailgunEmailPayloads(data: MailgunEmailPayloadUpdateManyMutationInput!, where: MailgunEmailPayloadWhereInput): BatchPayload!
  upsertMailgunEmailPayload(where: MailgunEmailPayloadWhereUniqueInput!, create: MailgunEmailPayloadCreateInput!, update: MailgunEmailPayloadUpdateInput!): MailgunEmailPayload!
  deleteMailgunEmailPayload(where: MailgunEmailPayloadWhereUniqueInput!): MailgunEmailPayload
  deleteManyMailgunEmailPayloads(where: MailgunEmailPayloadWhereInput): BatchPayload!
...
type Query {
  ...
  mailgunEmailPayload(where: MailgunEmailPayloadWhereUniqueInput!): MailgunEmailPayload
  mailgunEmailPayloads(where: MailgunEmailPayloadWhereInput, orderBy: MailgunEmailPayloadOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [MailgunEmailPayload]!
  mailgunEmailPayloadsConnection(where: MailgunEmailPayloadWhereInput, orderBy: MailgunEmailPayloadOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): MailgunEmailPayloadConnection!
...
type Subscription {
  ...
  mailgunEmailPayload(where: MailgunEmailPayloadSubscriptionWhereInput): MailgunEmailPayloadSubscriptionPayload
